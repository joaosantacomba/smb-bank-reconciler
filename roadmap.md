...
- [ ] **Task 1.1: Core Infrastructure & Parsing**
    - [x] Technical analysis and implementation plan approved.
    - [ ] Install `xlsx` and `@types/xlsx`.
    - [ ] Implement `ExcelParserService` (using `ArrayBuffer` and localization heuristic).
- [ ] **Task 1.2: Intelligent Row & Column Identification**
    - [ ] Logic to automatically identify "actual movement" rows vs. irrelevant rows.
    - [ ] Automatic header detection and metadata flagging.
